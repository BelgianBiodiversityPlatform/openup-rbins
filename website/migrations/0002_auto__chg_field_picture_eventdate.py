...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Picture.eventdate'
        raise RuntimeError("Cannot reverse this migration. 'Picture.eventdate' and its values cannot be restored.")
