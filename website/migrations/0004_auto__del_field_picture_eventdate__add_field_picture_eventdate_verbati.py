...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Picture.eventdate'
        db.delete_column('website_picture', 'eventdate')

        # Adding field 'Picture.eventdate_verbatim'
        db.add_column('website_picture', 'eventdate_verbatim',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Picture.eventdate'
        db.add_column('website_picture', 'eventdate',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Picture.eventdate_verbatim'
        db.delete_column('website_picture', 'eventdate_verbatim')
